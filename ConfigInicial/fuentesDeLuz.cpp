...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Previo9_Fuentes de luz_Alexa Lopez", nullptr, nullptr);
	...
	Model Dog((char*)"C:/Users/alexa/OneDrive/Escritorio/ConfigInicial/ConfigInicial/Models/tree.obj");
	//Model Dog((char*)"Models/tree.obj");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform1f(glGetUniformLocation(lightingShader.Program, "pointLights[1].constant"), 2.0f);
