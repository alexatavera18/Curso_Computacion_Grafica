...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Practica 6_Carga de modelos y camara sintetica_Alexa Lopez", nullptr, nullptr);
    ...
    Model pelota((char*)"BasketBall/BasketBall/BasketBall.obj");
